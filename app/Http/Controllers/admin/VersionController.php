    ...
    public function getallversions(Request $request){
        ...
        if (!empty($alldata)) {
            ...
            foreach ($alldata as $row) { 
                ...
                $actionhtml  =  '
                                <a href="'.url('admin/version/show/'.$row->id).'" title="View" class="btn btn-primary font-15 view" > <i class="fa fa-pencil"></i></a>
                                <a href="'.url('admin/version/edit/'.$row->id).'" title="Edit" class="btn btn-primary font-15 view" > <i class="fa fa-pencil"></i></a>
                               
                                <a href="'.url('admin/version/delete/'.$row->id).'" title="View" class="btn btn-primary font-15 view" > <i class="fa fa-pencil"></i></a>';
