...
<script type="text/javascript" id="rendered-js">
        ...
        $(document).on("click",".deletecurrencies",function() {
           return confirm("are you sure you want to delete this currencies?");
        });
                    ...
                    mRender: function ( data, type, row ) {
                      ...
                      var mRL = '{{url("/")}}';
                        return '<a href="'+mRL+'/admin/currencies/edit/'+row['id']+'" title="Edit" class="btn btn-success mr-1 font-15"><i class="fa fa-pencil"></i></a>'+
                               '<a href="'+URL+'/admin/currencies/delete/'+row['id']+'" title="Edit" class="btn btn-danger mr-1 font-15 deleteversion"><i class="fa fa-trash-o"></i></a>';
                    }
                }
            ]
