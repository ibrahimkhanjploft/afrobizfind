            ...
            "columns": [
                ...
                // { "data": "created_at" },
                {
                    mRender: function ( data, type, row ) {
                        return '<a href="/admin/version/show/'+row['id']+'" title="View" class="btn btn-primary mr-1 font-15"><i class="fa fa-eye"></i></a>'+
                            '<a href="/admin/version/edit/'+row['id']+'" title="Edit" class="btn btn-success mr-1 font-15"><i class="fa fa-pencil"></i></a>'+
